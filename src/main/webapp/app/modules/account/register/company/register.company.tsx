...
import { handleRegister, reset } from './register.company.reducer';
...
export class RegisterCompanyPage extends React.Component<IRegisterProps, IRegisterState> {
        ...
        <Row className="justify-content-center">
          <Col md="8">
            <h1 id="register-title">
              <Translate contentKey="register.company.title">Registration</Translate>
            </h1>
          </Col>
        </Row>
        <Row className="justify-content-center">
