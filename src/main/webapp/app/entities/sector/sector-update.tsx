...
export interface ISectorUpdateState {
  isNew: boolean;
}

export class SectorUpdate extends React.Component<ISectorUpdateProps, ISectorUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClose = () => {
    this.props.history.push('/entity/sector');
  };

  render() {
    const { sectorEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentPipeFrontendApp.sector.home.createOrEditLabel">
              <Translate contentKey="talentPipeFrontendApp.sector.home.createOrEditLabel">Create or edit a Sector</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : sectorEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="id">
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="talentPipeFrontendApp.sector.name">Name</Translate>
                  </Label>
                  <AvField
                    id="sector-name"
                    type="text"
                ...
                <AvGroup>
                  ...
                  <AvField id="sector-description" type="text" name="description" />
                </AvGroup>
                <Button tag={Link} id="cancel-save" to="/entity/sector" replace color="info">
