    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentpipeApp.area.home.createOrEditLabel">
              <Translate contentKey="talentpipeApp.area.home.createOrEditLabel">Create or edit a Area</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : areaEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="talentpipeApp.area.name">Name</Translate>
                  </Label>
                  <AvField
                    id="area-name"
                    type="text"
                ...
                <AvGroup>
                  <Label id="normalizedNameLabel" for="normalizedName">
                    <Translate contentKey="talentpipeApp.area.normalizedName">Normalized Name</Translate>
                  </Label>
                  <AvField
                    id="area-normalizedName"
                    type="text"
                    name="normalizedName"
                    validate={{
                      required: { value: true, errorMessage: translate('entity.validation.required') }
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="description">
                    <Translate contentKey="talentpipeApp.area.description">Description</Translate>
                  </Label>
