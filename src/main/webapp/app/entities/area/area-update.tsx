    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentPipeFrontendApp.area.home.createOrEditLabel">
              <Translate contentKey="talentPipeFrontendApp.area.home.createOrEditLabel">Create or edit a Area</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
