...
export class BenefitUpdate extends React.Component<IBenefitUpdateProps, IBenefitUpdateState> {
  ...
  render() {
    const { benefitEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentPipeFrontendApp.benefit.home.createOrEditLabel">
              <Translate contentKey="talentPipeFrontendApp.benefit.home.createOrEditLabel">Create or edit a Benefit</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : benefitEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="talentPipeFrontendApp.benefit.name">Name</Translate>
                  </Label>
                  <AvField
                    id="benefit-name"
                    type="text"
