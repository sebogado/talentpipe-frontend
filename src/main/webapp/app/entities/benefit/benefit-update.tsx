    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentpipeApp.benefit.home.createOrEditLabel">
              <Translate contentKey="talentpipeApp.benefit.home.createOrEditLabel">Create or edit a Benefit</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
