    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentPipeFrontendApp.country.home.createOrEditLabel">
              <Translate contentKey="talentPipeFrontendApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
