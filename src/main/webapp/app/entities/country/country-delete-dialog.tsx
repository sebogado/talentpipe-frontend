  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="talentPipeFrontendApp.country.delete.question">
          <Translate contentKey="talentPipeFrontendApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
