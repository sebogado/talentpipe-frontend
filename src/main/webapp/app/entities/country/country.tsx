              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('talentPipeFrontendApp.country.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('phoneCode')}>
                  <Translate contentKey="talentPipeFrontendApp.country.phoneCode">Phone Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('currency')}>
                  <Translate contentKey="talentPipeFrontendApp.country.currency">Currency</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
