  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="talentPipeFrontendApp.city.detail.title">City</Translate> [<b>{cityEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="name">
                <Translate contentKey="talentPipeFrontendApp.city.name">Name</Translate>
              </span>
            </dt>
            <dd>{cityEntity.name}</dd>
            <dt>
              <span id="postalCode">
                <Translate contentKey="talentPipeFrontendApp.city.postalCode">Postal Code</Translate>
              </span>
            </dt>
            <dd>{cityEntity.postalCode}</dd>
            <dt>
              <span id="sarasa">
                <Translate contentKey="talentPipeFrontendApp.city.sarasa">Sarasa</Translate>
              </span>
            </dt>
            <dd>{cityEntity.sarasa}</dd>
            <dt>
              <Translate contentKey="talentPipeFrontendApp.city.country">Country</Translate>
            </dt>
