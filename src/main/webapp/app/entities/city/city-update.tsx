    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentPipeFrontendApp.city.home.createOrEditLabel">
              <Translate contentKey="talentPipeFrontendApp.city.home.createOrEditLabel">Create or edit a City</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : cityEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="sarasaLabel" for="sarasa">
                    <Translate contentKey="talentPipeFrontendApp.city.sarasa">Sarasa</Translate>
                  </Label>
                  <AvField id="city-sarasa" type="text" name="sarasa" />
                </AvGroup>
                <AvGroup>
