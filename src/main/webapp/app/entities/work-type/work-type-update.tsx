    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentpipeApp.workType.home.createOrEditLabel">
              <Translate contentKey="talentpipeApp.workType.home.createOrEditLabel">Create or edit a WorkType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
