    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="talentpipeApp.companyType.home.createOrEditLabel">
              <Translate contentKey="talentpipeApp.companyType.home.createOrEditLabel">Create or edit a CompanyType</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : companyTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="talentpipeApp.companyType.name">Name</Translate>
                  </Label>
                  <AvField
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="description">
                    <Translate contentKey="talentpipeApp.companyType.description">Description</Translate>
                  </Label>
