...
import { TechnicalSkillComponent } from 'app/entities/technical-skill/technical-skill.component';
...
describe('Component Tests', () => {
    describe('TechnicalSkill Management Component', () => {
        let comp: TechnicalSkillComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TechnicalSkillComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.technicalSkills[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
