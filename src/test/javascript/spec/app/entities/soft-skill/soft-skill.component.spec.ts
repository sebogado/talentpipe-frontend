...
import { SoftSkillComponent } from 'app/entities/soft-skill/soft-skill.component';
...
describe('Component Tests', () => {
    describe('SoftSkill Management Component', () => {
        let comp: SoftSkillComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SoftSkillComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.softSkills[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
