...
describe('Service Tests', () => {
    describe('WorkType Service', () => {
        let injector: TestBed;
        let service: WorkTypeService;
        let httpMock: HttpTestingController;
        let elemDefault: IWorkType;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(WorkTypeService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new WorkType(0, 'AAAAAAA', 'AAAAAAA', 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of WorkType', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        description: 'BBBBBB',
