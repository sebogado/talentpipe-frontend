...
import { SearchTypeComponent } from 'app/entities/search-type/search-type.component';
...
describe('Component Tests', () => {
    describe('SearchType Management Component', () => {
        let comp: SearchTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SearchTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.searchTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
