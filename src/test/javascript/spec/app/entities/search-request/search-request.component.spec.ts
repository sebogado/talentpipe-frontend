...
import { SearchRequestComponent } from 'app/entities/search-request/search-request.component';
...
describe('Component Tests', () => {
    describe('SearchRequest Management Component', () => {
        let comp: SearchRequestComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SearchRequestComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.searchRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
